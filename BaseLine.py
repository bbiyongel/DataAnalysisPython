...
train_temp_copy_del_sqft_lot15['sqft_lot15'] = train_temp_copy_del_sqft_lot15['sqft_lot15'].map(lambda x: np.nan if x < sqft_lot15_threshold else x)
...
train_temp_copy_del_sqft_lot['sqft_lot'] = train_temp_copy_del_sqft_lot['sqft_lot'].apply(lambda x: np.nan if x < sqft_lot_threshold else x)
...
train_temp_copy_del_sqft_living['sqft_living'] = train_temp_copy_del_sqft_living['sqft_living'].apply(lambda x: np.nan if x < sqft_living_threshold else x)
...
train_temp_copy_del_sqft_above['sqft_above'] = train_temp_copy_del_sqft_above['sqft_above'].apply(lambda x: np.nan if x < sqft_above_threshold else x)
...
train_temp_copy_del_grade_price['grade'] = train_temp_copy_del_grade_price['grade'].apply(lambda x: np.nan if x != 11 else x )
train_temp_copy_del_grade_price['price'] = train_temp_copy_del_grade_price['price'].apply(lambda x: np.nan if x < grade_price_threshold else x)
...
train_temp_copy_del_bathroom_price['bathrooms'] = train_temp_copy_del_bathroom_price['bathrooms'].apply(lambda x: np.nan if x != 4.5 else x )
train_temp_copy_del_bathroom_price['price'] = train_temp_copy_del_bathroom_price['price'].apply(lambda x: np.nan if x < bathroom_price_threshold else x)
